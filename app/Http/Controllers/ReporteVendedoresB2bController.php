...
class ReporteVendedoresB2bController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reportes.vendedores_b2b.index', compact('plazas', 'tiendas', 'startDefault', 'endDefault'));
    }
    ...
    public function data(Request $request)
    {
        ...
        Log::info('Vendedores B2B data request', ['url' => $request->fullUrl(), 'params' => $request->all(), 'filter' => $userFilter]);
        ...
        try {
            ...
            Log::error('Vendedores B2B data error: '.$e->getMessage());
    ...
    public function export(Request $request)
    {
        try {
            ...
            return Excel::download(new VendedoresB2bExport($filtros),
                'Reporte_Vendedores_B2B_'.date('Ymd_His').'.xlsx'
            );

        } catch (\Exception $e) {
            Log::error('Error en export B2B: '.$e->getMessage());

            return redirect()->route('reportes.vendedores.b2b', $request->all())
    ...
    public function exportCsv(Request $request)
    {
        try {
            ...
            $filename = 'Reporte_Vendedores_B2B_'.date('Ymd_His').'.csv';
            ...
            Log::error('Error en exportCsv B2B: '.$e->getMessage());
    ...
    public function exportPdf(Request $request)
    {
        try {
            ...
            Log::error('Error en exportPdf B2B: '.$e->getMessage());
