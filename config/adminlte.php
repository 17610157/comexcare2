...
return [
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Reporte de Archivos Precios',
                    'icon' => 'far fa-file-alt',
                    'url' => 'reportes/dbf-files-especificos',
                    'can' => 'dbf-files-especificos.ver',
                ],
                [
                    'text' => 'Reporte de Conciliación de Archivos',
                    'icon' => 'far fa-file-alt',
                ...
                [
                    ...
                    'icon' => 'fas fa-server',
                    'url' => 'reportes/rbf-config-status',
                    'can' => 'reportes.rbf-config-status.ver',
                ],
            ],
        ],
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can add your custom CSS and JS files.
    |
    */
